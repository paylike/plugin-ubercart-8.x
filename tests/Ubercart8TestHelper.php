...
class Ubercart8TestHelper {
	...
	/**
	 * Ubercart8TestHelper constructor.
	 *
	 * @param \Ubercart\Ubercart8FullTest $ubercart8_test
	 */
	public function __construct( $ubercart8_test ) {
		$this->main_test    = $ubercart8_test;
		$this->wd           = $ubercart8_test->wd;
